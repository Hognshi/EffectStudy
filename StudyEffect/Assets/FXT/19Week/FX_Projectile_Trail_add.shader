...
Shader "SBS/Amplify Shader/19Week/FX_Projectile_Trail"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( pow( saturate( ( ( tex2D( _BaseTex, panner10 ).r + tex2DNode1.r ) * tex2DNode1.r ) ) , _MainPower ) * _MainIns ) * i.vertexColor ).rgb;
...
/*ASEBEGIN
Version=16700
694;348;1830;1181;2440.154;1065.75;1.797175;True;False
...
ASEEND*/
//CHKSM=182B46827931ACF750B851312595004BA79F8530