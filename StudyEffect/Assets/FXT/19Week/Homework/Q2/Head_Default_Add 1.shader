...
Shader "HomwWork/Projectile/Add"
{
	Properties
	{
	...
	SubShader
	{
		...
		{
			float4 color21 = IsGammaSpace() ? float4(0.6862745,0.4823529,1,1) : float4(0.4286906,0.1980693,1,1);
...
/*ASEBEGIN
Version=16700
361;447;1261;924;1543.198;367.9506;1.852934;True;False
...
Node;AmplifyShaderEditor.ColorNode;21;-615.3769,-284.4185;Float;False;Constant;_Color0;Color 0;7;0;Create;True;0;0;False;0;0.6862745,0.4823529,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=CF8F2E82EF2E2C9184FD83EB1FB732F04C0D1711