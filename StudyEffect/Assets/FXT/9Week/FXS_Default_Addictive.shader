	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float distanceDepth32 = abs( ( screenDepth32 - LinearEyeDepth( ase_screenPosNorm.z ) ) / ( _DepthFade ) );
				...
				float staticSwitch37 = ( i.vertexColor.a * saturate( distanceDepth32 ) );
			#else
				float staticSwitch37 = i.vertexColor.a;
			#endif
...
/*ASEBEGIN
Version=16700
250;60;1285;878;1102.175;513.8087;1;True;False
...
ASEEND*/
//CHKSM=C54BFA564363B51EE57D2631C7F7345E07161040