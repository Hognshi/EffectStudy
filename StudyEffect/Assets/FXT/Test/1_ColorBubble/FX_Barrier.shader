...
Shader "Circle"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( ( pow( tex2D( _FXT_ColorGradient, temp_cast_1 ) , temp_cast_2 ) * _Ins ) * i.vertexColor ) + float4( 0,0,0,0 ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=16700
166;151;1786;1054;-600.7245;502.9819;1;True;False
...
Node;AmplifyShaderEditor.PowerNode;115;810.0044,-139.244;Float;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;1393.94,-12.91219;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=D4879BFB970549B7CFF1B4786F5C8A6DA11FFFAC